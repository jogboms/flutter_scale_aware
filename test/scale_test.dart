...
void main() {
  group("on null parameters", () {
    test("with all null", () async {
      expect(() => Scale(size: null, textScaleFactor: null, config: null), throwsAssertionError);
    });

    test("with null textScaleFactor", () async {
      expect(() => Scale(size: Size.zero, textScaleFactor: null, config: const ScaleConfig()), throwsAssertionError);
    });

    test("with null config", () async {
      expect(() => Scale(size: Size.zero, textScaleFactor: 1, config: null), throwsAssertionError);
    });

    test("with null size", () async {
      expect(() => Scale(size: null, textScaleFactor: 1, config: const ScaleConfig()), throwsAssertionError);
    });
  });
